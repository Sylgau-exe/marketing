...
CREATE TABLE IF NOT EXISTS market_segments (
  ...
  description TEXT,
  pref_price_sensitivity DECIMAL(5,2) DEFAULT 0.15,
  pref_performance DECIMAL(5,2) DEFAULT 0.15,
  pref_durability DECIMAL(5,2) DEFAULT 0.15,
  pref_style DECIMAL(5,2) DEFAULT 0.15,
  pref_comfort DECIMAL(5,2) DEFAULT 0.15,
  pref_lightweight DECIMAL(5,2) DEFAULT 0.15,
  pref_customization DECIMAL(5,2) DEFAULT 0.10,
